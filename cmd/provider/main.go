...
import (
	...
	"github.com/jeremywyx/provider-harness/apis"
	harness "github.com/jeremywyx/provider-harness/internal/controller"
	"github.com/jeremywyx/provider-harness/internal/version"
)
	...
	if *enableChangeLogs {
		...
		clo := controller.ChangeLogOptions{
			ChangeLogger: managed.NewGRPCChangeLogger(
				...
				managed.WithProviderVersion(fmt.Sprintf("provider-harness:%s", version.Version))),
		}
		o.ChangeLogOptions = &clo
	}

	kingpin.FatalIfError(customresourcesgate.Setup(mgr, o), "Cannot setup CRD gate controller")
	kingpin.FatalIfError(harness.SetupGated(mgr, o), "Cannot setup Harness controllers")
