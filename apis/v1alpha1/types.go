...
type ProviderConfigSpec struct {
	...
	// Endpoint is the Harness API Endpoint.
	// +optional
...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,provider,harness}
...
// A ClusterProviderConfig configures a Harness provider.
